...
const ResetPassword = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    if (!token) {
      // errorAlert({ title: "Error", text: "Invalid or missing token." });
      toast.error("Error", "Invalid or missing token.");
      return;
    }
    ...
    try {
      ...
      // });
      toast.error("Error", err?.data?.message || "Failed to reset password.");
    }
  };

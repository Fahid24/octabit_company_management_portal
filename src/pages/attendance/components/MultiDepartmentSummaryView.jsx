...
const MultiDepartmentSummaryView = ({
  employeesBySelectedDepartment,
  startDate,
  endDate,
  formatDateRangeText,
}) => {
  return (
    <div className="mt-8 grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
      {employeesBySelectedDepartment.map((dept) => (
        <div
          key={dept.name}
          className="bg-white overflow-hidden rounded-lg shadow-md hover:shadow-lg transition-all duration-300 border-l-4 border-primary"
        >
...
export default MultiDepartmentSummaryView;

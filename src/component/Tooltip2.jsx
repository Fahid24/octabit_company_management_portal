...
export default function Tooltips({ children, text, position = "top", email = false }) {
    ...
    >
      ...
      {visible && (
        <div
          ...
          ${email ? "whitespace-normal break-words max-w-sm" : "whitespace-wrap w-[250px] md:w-[350px] "}transition-all duration-200 ${positionClass[position]}`}
        >
          {text}
          <span
